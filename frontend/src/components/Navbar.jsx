...
const Navbar = ({ onLogout }) => {
  ...
  return (
    <nav className="bg-gray-800 px-6 py-4 flex justify-between items-center shadow-md shadow-black/30 relative">
      {/* Logo */}
  ...
  <button
    onClick={onLogout}
    className="inline-flex items-center justify-center h-10 px-4 bg-red-600 hover:bg-red-700 text-white rounded-md transition"
  >
    Logout
  </button>
</div>
